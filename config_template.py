# config_template.py
"""
Configuration template - copy this to config.py and add your API keys
"""
...
TWITTER_API_CONFIG = {
    ...
    'headers': {
        "x-rapidapi-key": os.getenv("RAPIDAPI_KEY") or st.secrets.get("RAPIDAPI_KEY", "your_rapidapi_key_here"),
        "x-rapidapi-host": "twitter-api-v1-1-enterprise.p.rapidapi.com",
    },
    'api_key': os.getenv("TWITTER_API_KEY") or st.secrets.get("TWITTER_API_KEY", "your_twitter_api_key_here")
}

OPENAI_API_KEY = os.getenv("OPENAI_API_KEY") or st.secrets.get("OPENAI_API_KEY", "your_openai_api_key_here")
